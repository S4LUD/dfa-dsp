...
export default function Preview({ navigation, route }) {
  ...
  const Transaction = async () => {
    ...
    if (data.type === "load") {
      ...
      await fetch("https://dfa-db.herokuapp.com/api/dsp/customerload", {
        method: "POST",
        ...
        .then(async (results) => {
          ...
          await fetch("https://dfa-db.herokuapp.com/api/dsp/loadsale", {
            method: "PATCH",
            headers: { "Content-Type": "application/json" },
            body: rawed,
          })
      ...
      await fetch("https://dfa-db.herokuapp.com/api/dsp/customerpocsim", {
        method: "POST",
        headers: { "Content-Type": "application/json" },
        body: raw,
        redirect: "follow",
